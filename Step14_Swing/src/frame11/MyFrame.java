   ...
   public MyFrame() {
      ...
      plusBtn.addActionListener(new ActionListener() {
		...
		public void actionPerformed(ActionEvent e) {
			try {
				Float tfn1=Float.parseFloat(tf_num1.getText());
  				Float tfn2=Float.parseFloat(tf_num2.getText());
  				Float result=tfn1+tfn2;
				label_result.setText(result.toString());
			}catch(NumberFormatException nfe){
				JOptionPane.showMessageDialog(MyFrame.this, "숫자 형식으로 입력해 주세요.");
			}
		}
	});
