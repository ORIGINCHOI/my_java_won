...
public class MainClass16 {	
	public static void main(String[] args) {
		...
		try {
			//파일에서 byte 를 읽어낼 객체
			fis=new FileInputStream("C:/Users/ORIGIN/myFolder/bottle.png");
			//파일에 byte 를 출력할 객체
		    fos=new FileOutputStream("C:/Users/ORIGIN/myFolder/copied2.png");
		    
		    //byte[] 객체를 미리 준비한다.
		    byte[] buffer=new byte[1024]; //한번에 1kilo byte 씩 읽어낼 수 있는 byte 배열
